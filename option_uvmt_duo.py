...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--scales",
                                 ...
                                 default=[0])
        self.parser.add_argument("--scales1",
                                 nargs="+",
                                 type=int,
                                 help="scales used in the loss",
                                 default=[0])
        ...
        self.parser.add_argument("--learning_rate",
                                 type=float,
                                 help="learning rate",
                                 default=1e-4) #bs:10,1e-4/bs:8,7e-5
        ...
        self.parser.add_argument("--disable_automasking",default=False,##True/False
