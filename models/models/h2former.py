...
class Res34_Swin_MS(nn.Module):  ###  low resolution + Multi-scale
    def __init__(self, image_size, block, layers, num_classes, zero_init_residual=False, groups=1, width_per_group=64):
        ...
        patch_size = [2, 4, 8, 16]
        self.patch_embed = PatchEmbed1(img_size=image_size, patch_size=patch_size, in_chans=3, embed_dim=embed_dim)
        self.MS2 = PatchMerging1(64)
        self.MS3 = PatchMerging1(128)
        self.MS4 = PatchMerging1(256)
...
def res34_swin_MS(num_classes):
    image_size = (320, 320)
    return Res34_Swin_MS(image_size[0], BasicBlock, [3, 4, 6, 3], num_classes=num_classes)