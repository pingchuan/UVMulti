...
from models.ResNet34UNet import ResNet34U1
def generate_pseudo_labels(model_t, img_path, confidence_threshold=0.95, device='cuda', target_size=(256, 256)):
    """
    根据教师网络生成伪标签
...
class BenthicDataset(data.Dataset):
    ...
    def get_gt_t(self, folder, frame_index, image_folder):
        ...
        img_path = os.path.join(self.data_path, folder, f_str)
        # 修改路径，检查是否存在GT图像
    ...
    def check_depth(self):
        ...
        velo_filename = os.path.join(
            self.data_path,
            scene_name,
            "depth/{}.png".format(int(frame_index)))
